  ...
  return (
    <div>
      ...
      <div className="flex flex-col place-items-center mt-8">
        <TbTruckDelivery className="text-[#3C9379] w-16 h-16" />{" "}
        <p className="text-base font-extralight  md:text-xl lg:text-2xl manrope-font text-center">
          Free Delivery
        </p>
      </div>{" "}
...
const Trusted = () => {
  return (
    <div>
      <div className="flex flex-col place-items-center mt-8">
        <VscWorkspaceTrusted className="text-[#3C9379] w-16 h-16 " />{" "}
        <p className="text-base font-extralight  md:text-xl lg:text-2xl manrope-font text-center">
          Trusted Platform
        </p>
      </div>{" "}
